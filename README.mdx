...
You can also install it using `yarn add --dev @prodo-ai/snoopy-cli` or `npm
install --save-dev @prodo-ai/snoopy-cli`.
...
If you want to include any application-level CSS files, just put a `/*
@prodo:styles */` comment anywhere inside the file, and they will be applied to
all your examples.
